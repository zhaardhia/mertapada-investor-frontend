...
interface ModalVerifItemShopType {
  setShowModal: React.Dispatch<React.SetStateAction<boolean>>;
  onApproved: () => Promise<string>;
}

const ModalVerifItemShop: React.FC<ModalVerifItemShopType> = ({ setShowModal, onApproved }) => {
  ...
  const handleApproved = () => {
    try {
      onApproved()
      setMsgSuccess("Sukses melakukan verifikasi data belanja.")
    } catch (error) {
      console.error(error)
      setMsgError("Gagal melakukan verifikasi data belanja. Silahkan hubungi admin.")
    }
    setTimeout(() => {
      setShowModal(false)
    }, 4000)
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[90%] mx-auto bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              <h3 className="text-2xl text-center font-semibold">Verifikasi Laporan Belanja</h3>
              <button
            ...
            <div className="relative p-6 flex-auto">
              <p>Apakah anda yakin sudah menyimpan data laporan belanja dengan benar?</p>
...
export default ModalVerifItemShop;
